class InitialAnswer < ApplicationRecord
  ...
  def set_wrong_answers
    ...
    #{initial_question}, which are different from the correct answer (which is  #{content}) and are realistic responses to the question, exclude any additional
    characters and as one string."
